...
Multi-Tenant Application built with REACT (FE) and AWS lambda (API), changes its behavior/content according to a tenant, so use different (given) login credential to verify the same. <br>
